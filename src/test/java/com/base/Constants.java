...
public class Constants {
    ...
    public static String EXTENT_REPORT_CONFIG_XML = USER_DIR + "/src/main/resources/extent-config.xml";
	...
	public static String CMO_Directory = "C:\\Workspaces\\Consumer-PROD\\LiveContent\\MYB\\Content\\";
